...
def main():
    ...
    parser.add_argument('--d1',
                        ...
                        default='/home/exx/Documents/Mengda-Research/Spirl/data/maze2d-medium-dynamic-layout')
    parser.add_argument('--d2',
                        type=str,
                        help='path to dataset',
                        default='/home/exx/Documents/Mengda-Research/D-spirl/data/matrix_maze_avoid')
